...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = $pdo->prepare("UPDATE member SET firstname = :firstname, lastname = :lastname, b_date = :b_date, email = :email, contact_number = :contact_number, address = :address WHERE user_id = :user_id");
        ...
        <div class="form-box">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="b_date" name="b_date" value="<?php echo htmlspecialchars($member['b_date']); ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="contact_number" name="contact_number" value="<?php echo htmlspecialchars($member['contact_number']); ?>" required>
                </div>
                <div class="form-group">
